						...
						<div class="row">
							<div class="col-md-9 col-lg-8 mx-auto">
								...
								<sec:authorize access="isAuthenticated()">
									<form action="<c:url value='/loginout.kosmo'/>" method="POST">
			    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>	
								...
								<div class="text-center">
									<a class="small" href="#">아이디 찾기</a> | <a class="small"
										href="#">비밀번호 찾기</a> | <a class="small"
										href="<c:url value='/sign_up_page.kosmo'/>">회원 가입</a>
								</div>
